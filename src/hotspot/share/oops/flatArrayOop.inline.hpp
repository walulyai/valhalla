...
void flatArrayOopDesc::oop_iterate_elements_range(OopClosureType* blk, int start, int end) {
  if (UseCompressedOops) {
    ((FlatArrayKlass*)klass())->oop_oop_iterate_elements_range<narrowOop>(this, blk, start, end);
  } else {
    ((FlatArrayKlass*)klass())->oop_oop_iterate_elements_range<oop>(this, blk, start, end);
  }
}
